  ...
  return (
    <>
      <form onSubmit={cadastrar}>
        <input type='text' placeholder='Nome do Evento' value={nomeevento} onChange={(e: any) => { setNomeEvento(e.target.value); }} />
        <input type='text' placeholder='Local do Evento' value={local} onChange={(e: any) => { setLocal(e.target.value); }} />
        <input type='text' placeholder='Dia da Semana' value={diasemana} onChange={(e: any) => { setDiaSemana(e.target.value); }} />
        <input type='text' placeholder="Horário" value={horario} onChange={(e: any) => { setHorario(e.target.value); }} />
